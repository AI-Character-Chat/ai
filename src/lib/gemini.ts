...
- dialogue 핵심: ${un}이 캐릭터에게 신체접촉(키스, 포옹, 밀기 등)을 했다면, 해당 캐릭터의 dialogue 첫 마디는 반드시 의성어·감탄사("크흡...", "하아...", "엇...")로 시작한다. 이어지는 대사 전체가 그 접촉으로 인한 감정적 동요에 대한 것이다. 차가운 캐릭터도 동요를 숨기려 하면서 드러내라. 이 턴에서 다른 주제(임무, 상황)로 넘어가지 마라.
