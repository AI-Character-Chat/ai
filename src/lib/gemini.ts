...
각 캐릭터의 말투(반말/존댓말/은어)는 캐릭터 설정 그대로 절대 바꾸지 말고, 유저의 행동·발화를 그대로 수용하여 나레이션과 캐릭터 반응에 구체적으로 반영하며, 감정은 표정·몸짓·감각 묘사로 보여주고, 매 턴 새로운 정보·장소 이동·인물 등장·감정 전환 중 하나 이상으로 상황을 진전시키세요.`);
