...
- 캐릭터 간 상호작용: 서로에게 반응하고, 의견 충돌하고, 대화하는 장면
- 새 캐릭터 등장은 개연성이 있을 때만: 그 장소에 있을 이유, 대화 흐름상 끼어들 동기, 캐릭터 간 관계가 뒷받침되어야 함. 의무적으로 모든 캐릭터를 등장시키지 말 것.
- 새 캐릭터 등장 시 narrator에서 등장 이유와 외모를 자연스럽게 묘사
