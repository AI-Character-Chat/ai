...
type Tab = 'dashboard' | 'banners' | 'announcements' | 'users' | 'reports' | 'settings' | 'memory' | 'devlog';
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
          {[
            ...
            { id: 'devlog', label: '개발 로그', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' }
          ].map((tab) => (
            <button
              key={tab.id}
